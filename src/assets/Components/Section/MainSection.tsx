      ...
      <div className="space-y-2">
        {dateHistory.slice(0, 2).map((e, i) => (
          ...
          >
            ...
            <p className="flex-1 text-base text-cyan-50 font-medium">{e}</p>

            <span className="text-xs text-cyan-400 uppercase">time</span>
          </div>
        ))}
      </div>
    </div>
        ...
        <div className="grid grid-rows-3 gap-4 flex-1">
          <div className="flex items-center justify-center row-span-1 px-4 py-3 rounded-lg bg-slate-900/50 border border-cyan-700/50">
            <div className="flex flex-col items-center">
              ...
              <span className="text-2xl text-cyan-50 font-bold">{name}</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 row-span-1">
            <div className="flex flex-col items-center justify-center px-4 py-3 rounded-lg bg-slate-900/50 border border-cyan-700/50">
              ...
              <div className="flex flex-row gap-5">
                <button className="p-1.5 rounded-lg bg-linear-to-r from-cyan-600/20 to-blue-600/20 border border-cyan-500/50 text-cyan-300 hover:from-cyan-500/30 hover:to-blue-500/30 hover:shadow-lg hover:shadow-cyan-500/30 transition-all">
                  <ChevronLeft
                    size={18}
                    strokeWidth={2.5}
                    onClick={() => decrementCurrent(tabs, currentTab)}
                  />
                </button>
                ...
                <button
                  className="px-3 py-1 text-xs text-cyan-300 uppercase tracking-wide rounded-lg bg-linear-to-r from-cyan-600/20 to-blue-600/20 border border-cyan-500/50 hover:from-cyan-500/30 hover:to-blue-500/30 hover:shadow-lg hover:shadow-cyan-500/30 transition-all"
                  onClick={() =>
                    setTabs((prev) =>
                      prev.map((tabs, index) =>
            ...
            <div className="flex flex-col items-center justify-center px-4 py-3 rounded-lg bg-slate-900/50 border border-cyan-700/50">
              ...
              <div className="flex flex-row gap-4">
                ...
                <span className="text-xl text-blue-400 font-bold">{max}</span>
                <button className="p-1.5 rounded-lg bg-linear-to-r from-cyan-600/20 to-blue-600/20 border border-cyan-500/50 text-cyan-300 hover:from-cyan-500/30 hover:to-blue-500/30 hover:shadow-lg hover:shadow-cyan-500/30 transition-all">
                  <ChevronRight
                    size={18}
                    strokeWidth={2.5}
    ...
    <div className="flex flex-col gap-3 h-full p-4 rounded-lg from-slate-800 via-slate-900 to-slate-950 overflow-auto border border-cyan-500/30 shadow-lg shadow-cyan-500/10">
      ...
      {!isEmpty ? (
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 px-3">
                    <span className="text-xs text-cyan-300">Hotkey:</span>
        ...
        <p className="text-center my-auto">
          Create More Tasks Using The "+" Button On The Tab Bar To Partially
          View Your Other Tasks Progress
        </p>
      )}
    </div>
  );
