...
<div className="flex flex-col gap-3 h-full p-3 rounded-lg border border-cyan-500/30 shadow-lg shadow-cyan-500/10 bg-linear-to-br from-slate-800 via-slate-900 to-slate-950">
  ...
  <div className="flex flex-col gap-3 flex-1 ">
    <div className="flex items-center justify-center px-3 py-4 rounded-lg border border-cyan-700/50 bg-slate-900/50 ">
    ...
    <div className="flex flex-col gap-3 2xl:grid 2xl:grid-cols-2">
      <div className="flex flex-col items-center justify-center px-3 py-4 rounded-lg border border-cyan-700/50 bg-slate-900/50">
        <span className="mb-1 text-xl text-cyan-300 uppercase tracking-wide">
          Progress
        </span>
    ...
    <div className="flex flex-col gap-3 2xl:grid 2xl:grid-cols-2">
      ...
      {/*Total Completion */}
      <div
        className={`flex flex-col items-center justify-center px-3 py-4 rounded-lg transition-all duration-700 ${
          totalCompletionColor
