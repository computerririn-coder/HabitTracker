...
const Box4 = React.memo(({ tabs, currentTab }: Box4Props) => {
  ...
  return (
    <div className="flex flex-col gap-3 min-h-40 md:h-full p-4 rounded-lg overflow-auto border border-cyan-500/30 shadow-lg shadow-cyan-500/10 from-slate-800 via-slate-900 to-slate-950">
      <h1 className="pb-2 text-sm text-cyan-300 uppercase tracking-wide border-b border-cyan-500/20 2xl:text-2xl">
        All Tasks List
      </h1>
      {!isEmpty ? (
          ...
          {tabs!
            ...
            .map((e, i) => {
              ...
              return (
                <div
                  key={i}
                  className={`flex flex-col gap-1 w-full  h-30 p-2 rounded-lg transition-all duration-700 xl:h-40  ${
                    isCompleted
                ...
                >
                  <div className="flex items-center gap-2 px-2 ">
                    <span className="text-cyan-300 text-[1em] xl:text-[1.5em]">
                      Name:
                    </span>
                    <span className="font-semibold text-cyan-50 truncate text-[1em] xl:text-[1.5em]">
                      {e.name}
                    </span>
                  </div>
                  ...
                  <div className="flex items-center gap-2 px-2">
                    ...
                    <span className="px-1.5 py-0.5 font-mono font-semibold text-cyan-50 rounded border border-cyan-700/50 bg-slate-900/70 text-[1em] xl:text-[1.5em]">
                      {e.hotKey}
                    </span>
                  </div>
                  ...
                  <div className="flex items-center gap-2 px-2">
                    ...
                    <span className="font-semibold text-cyan-400 text-[1em] xl:text-[1.5em]">
                      {percentage}%
                    </span>
                  </div>
                </div>
